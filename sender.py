...
from a5_embedding_extraction import embed_in_dwt_bands, bytes_to_bits
...
def main():
    ...
    try:
        while True:
            ...
            if cmd == 'send':
                if not os.path.exists('1759491992398.jpeg'):
                    print("[!] Cover image '1759491992398.jpeg' not found!")
                    continue
                send_encrypted_message(identity, '1759491992398.jpeg')
