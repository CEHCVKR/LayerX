...
| Test | Status | Details |
|------|--------|----------|
| AES Encryption | ❌ FAIL | Encryption failed: 'bytes' object has no attribute |
| Huffman Compression | ✅ PASS | Ratio: 47.27% |
| DWT Embedding | ✅ PASS | PSNR: 51.22 dB |
...
| 512x512 | ✅ PASS | PSNR: 51.13 dB |
| 1024x1024 | ✅ PASS | PSNR: 57.19 dB |
...
| Test | Status | Details |
|------|--------|----------|
| 16B | ✅ PASS | PSNR: 59.32 dB |
| 64B | ✅ PASS | PSNR: 59.03 dB |
| 256B | ✅ PASS | PSNR: 58.45 dB |
...
| Q=90 | ✅ PASS | PSNR: 36.34 dB |
| Q=85 | ❌ FAIL | PSNR: 32.83 dB |
| Q=80 | ❌ FAIL | PSNR: 30.51 dB |
...
| Textured Pattern | ✅ PASS | PSNR: 51.15 dB |
