...
**Generated:** 2026-01-18 21:45:35
**Analysis ID:** 20260118_214508
...
|------------|--------------|-----------|--------------|----------------|---------------|
| natural | 128 B | 60.36 | LOW | LOW | LOW |
| natural | 512 B | 54.39 | LOW | LOW | LOW |
| natural | 2,048 B | 48.33 | LOW | LOW | LOW |
| natural | 8,192 B | 42.98 | LOW | LOW | LOW |
| noisy | 128 B | 60.20 | LOW | LOW | LOW |
| noisy | 512 B | 54.32 | LOW | LOW | LOW |
| noisy | 2,048 B | 48.31 | LOW | LOW | LOW |
| noisy | 8,192 B | 42.69 | LOW | LOW | LOW |
| smooth | 128 B | 60.26 | LOW | LOW | LOW |
| smooth | 512 B | 54.02 | MEDIUM | LOW | LOW |
| smooth | 2,048 B | 48.13 | HIGH | HIGH | HIGH |
| smooth | 8,192 B | 42.92 | HIGH | HIGH | HIGH |

## Key Security Findings

1. **Low Risk Scenarios:** 10 tests with average PSNR 52.58 dB
...
**Data Location:** `security_research_20260118_214508/results/security_results.json`
