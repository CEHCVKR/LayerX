...
| DWT Embedding | ✅ PASS | PSNR: 51.11 dB |
...
| 512x512 | ✅ PASS | PSNR: 51.15 dB |
| 1024x1024 | ✅ PASS | PSNR: 57.10 dB |
...
| 64B | ✅ PASS | PSNR: 58.71 dB |
| 256B | ✅ PASS | PSNR: 58.29 dB |
| 1024B | ✅ PASS | PSNR: 56.59 dB |
| 4096B | ✅ PASS | PSNR: 52.06 dB |
...
| Test | Status | Details |
|------|--------|----------|
| Q=95 | ✅ PASS | PSNR: 42.28 dB |
| Q=90 | ✅ PASS | PSNR: 36.37 dB |
| Q=85 | ❌ FAIL | PSNR: 32.85 dB |
| Q=80 | ❌ FAIL | PSNR: 30.54 dB |
| Q=70 | ❌ FAIL | PSNR: 27.94 dB |
